...
inline std::map<std::string, SettingRef> settingFields() {
    return {
        ...
        {"esp_snap_center",{SettingRef::BOOL,  &g_espSnapCenter}},
        ...
        {"esp_spectators", {SettingRef::BOOL,  &g_espSpectators}},
        {"esp_alpha",      {SettingRef::INT,   &g_espAlpha}},
        {"esp_thickness",  {SettingRef::FLOAT, &g_espThickness}},
        {"esp_text_size",  {SettingRef::FLOAT, &g_espTextSize}},
        {"box_min_px",     {SettingRef::FLOAT, &g_boxMinPx}},
        {"box_headroom",   {SettingRef::FLOAT, &g_boxHeadroom}},
        {"max_esp_dist",   {SettingRef::FLOAT, &g_maxEspDist}},
        {"fov_scale",      {SettingRef::FLOAT, &g_fovScale}},
        ...
        {"aim_ignore_spectators", {SettingRef::BOOL, &g_aimIgnoreSpectators}},
        ...
        {"aim_show_fov",   {SettingRef::BOOL,  &g_aimShowFov}},
        ...
        {"aim_curve_x",    {SettingRef::FLOAT, &g_aimCurveX}},
        {"aim_curve_y",    {SettingRef::FLOAT, &g_aimCurveY}},
        {"aim_curve_above",{SettingRef::BOOL,  &g_aimCurveAbove}},
        ...
        {"sonar_enabled",  {SettingRef::BOOL,  &g_sonarEnabled}},
        {"sonar_range",    {SettingRef::FLOAT, &g_sonarRange}},
        {"sonar_alpha",    {SettingRef::INT,   &g_sonarAlpha}},
        {"sonar_letters",  {SettingRef::BOOL,  &g_sonarLetters}},
        {"sonar_rings",    {SettingRef::BOOL,  &g_sonarRings}},
        {"sonar_lock",     {SettingRef::BOOL,  &g_sonarLock}},
        {"sonar_x",        {SettingRef::FLOAT, &g_sonarX}},
        {"sonar_y",        {SettingRef::FLOAT, &g_sonarY}},
        {"sonar_w",        {SettingRef::FLOAT, &g_sonarW}},
        {"sonar_h",        {SettingRef::FLOAT, &g_sonarH}},
        {"oof_enabled",      {SettingRef::BOOL,  &g_oofEnabled}},
        {"oof_radius",       {SettingRef::FLOAT, &g_oofRadius}},
        {"oof_size",         {SettingRef::FLOAT, &g_oofSize}},
        {"oof_max_dist",     {SettingRef::FLOAT, &g_oofMaxDist}},
        {"oof_scale_dist",   {SettingRef::BOOL,  &g_oofScaleDist}},
        {"oof_alpha",        {SettingRef::INT,   &g_oofAlpha}},
        {"oof_far_alpha",    {SettingRef::INT,   &g_oofFarAlpha}},
        {"oof_letters",      {SettingRef::BOOL,  &g_oofLetters}},
        {"oof_distance",     {SettingRef::BOOL,  &g_oofDistance}},
        {"oof_height",       {SettingRef::BOOL,  &g_oofHeight}},
        {"oof_height_m",     {SettingRef::FLOAT, &g_oofHeightM}},
        {"oof_health",       {SettingRef::BOOL,  &g_oofHealth}},
        {"oof_teammates",    {SettingRef::BOOL,  &g_oofTeammates}},
        {"oof_flash",        {SettingRef::BOOL,  &g_oofFlash}},
        {"oof_flash_dist",   {SettingRef::FLOAT, &g_oofFlashDist}},
        {"oof_flash_min_hz", {SettingRef::FLOAT, &g_oofFlashMinHz}},
        {"oof_flash_max_hz", {SettingRef::FLOAT, &g_oofFlashMaxHz}},
